...
bool UnicodeChromaAnimationAPI::_sIsInitializedAPI = false;

#define CHROMASDK_DECLARE_METHOD_IMPL(Signature, FieldName) Signature UnicodeChromaAnimationAPI::FieldName = nullptr;
...
int UnicodeChromaAnimationAPI::InitAPI()
{
...
bool UnicodeChromaAnimationAPI::GetIsInitializedAPI()
{
	return _sIsInitializedAPI;
}

#undef CHROMASDK_DECLARE_METHOD_CLEAR
#define CHROMASDK_DECLARE_METHOD_CLEAR(FieldName) UnicodeChromaAnimationAPI::FieldName = nullptr;

int UnicodeChromaAnimationAPI::UninitAPI()
{
