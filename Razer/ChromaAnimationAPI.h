...
#pragma region API declare prototypes
		...
		*/
		static void AddNonZeroAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double AddNonZeroAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
		...
		*/
		...
		/*
			...
			name.
		*/
		static void AddNonZeroAllKeysAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int offset);
		/*
			D suffix for limited data types.
		*/
		static double AddNonZeroAllKeysAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double offset);
		/*
			Add source color to target where color is not black for frame id, reference
			source and target by name.
		*/
		static void AddNonZeroAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
		/*
		...
		*/
		static void AddNonZeroAllKeysOffsetName(const char* sourceAnimation, const char* targetAnimation, int frameId, int offset);
		/*
			D suffix for limited data types.
		*/
		static double AddNonZeroAllKeysOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double offset);
		/*
		...
		*/
		static void AddNonZeroTargetAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double AddNonZeroTargetAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
			Add source color to target where the target color is not black for all frames
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void AddNonZeroTargetAllKeysAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int offset);
		/*
			D suffix for limited data types.
		*/
		static double AddNonZeroTargetAllKeysAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double offset);
		/*
		...
		*/
		static void AddNonZeroTargetAllKeysOffsetName(const char* sourceAnimation, const char* targetAnimation, int frameId, int offset);
		/*
			D suffix for limited data types.
		*/
		static double AddNonZeroTargetAllKeysOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double offset);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void AppendAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double AppendAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
		...
		*/
		static void CloseAnimationName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double CloseAnimationNameD(const char* path);
		/*
		...
		*/
		static void CloseComposite(const char* name);
		/*
			D suffix for limited data types.
		*/
		static double CloseCompositeD(const char* name);
		/*
		...
		*/
		...
		/*
			...
			target are referenced by id.
		*/
		static void CopyAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
		/*
			Copy animation to named target animation in memory. If target animation
			exists, close first. Source is referenced by id.
		*/
		static int CopyAnimation(int sourceAnimationId, const char* targetAnimation);
		/*
			Copy animation to named target animation in memory. If target animation
			exists, close first. Source is referenced by name.
		*/
		static void CopyAnimationName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double CopyAnimationNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
		...
		*/
		static void CopyBlueChannelAllFramesName(const char* path, float redIntensity, float greenIntensity);
		/*
			D suffix for limited data types.
		*/
		static double CopyBlueChannelAllFramesNameD(const char* path, double redIntensity, double greenIntensity);
		/*
		...
		*/
		static void CopyGreenChannelAllFramesName(const char* path, float redIntensity, float blueIntensity);
		/*
			D suffix for limited data types.
		*/
		static double CopyGreenChannelAllFramesNameD(const char* path, double redIntensity, double blueIntensity);
		/*
		...
		*/
		static void CopyKeyColorAllFramesName(const char* sourceAnimation, const char* targetAnimation, int rzkey);
		/*
			D suffix for limited data types.
		*/
		static double CopyKeyColorAllFramesNameD(const char* sourceAnimation, const char* targetAnimation, double rzkey);
		/*
			Copy animation key color from the source animation to the target animation
		...
		*/
		static void CopyKeyColorAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int rzkey, int offset);
		/*
			D suffix for limited data types.
		*/
		static double CopyKeyColorAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double rzkey, double offset);
		/*
			Copy animation key color from the source animation to the target animation
			for the given frame.
		*/
		static void CopyKeyColorName(const char* sourceAnimation, const char* targetAnimation, int frameId, int rzkey);
		/*
			D suffix for limited data types.
		*/
		static double CopyKeyColorNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double rzkey);
		/*
		...
		*/
		static void CopyKeysColorAllFramesName(const char* sourceAnimation, const char* targetAnimation, const int* keys, int size);
		/*
			Copy animation color for a set of keys from the source animation to the
			target animation for the given frame. Reference the source and target by
			name.
		*/
		static void CopyKeysColorName(const char* sourceAnimation, const char* targetAnimation, int frameId, const int* keys, int size);
		/*
			Copy animation color for a set of keys from the source animation to the
		...
		*/
		...
		/*
			...
			source and target by name.
		*/
		static void CopyKeysColorOffsetName(const char* sourceAnimation, const char* targetAnimation, int sourceFrameId, int targetFrameId, const int* keys, int size);
		/*
			Copy source animation to target animation for the given frame. Source and
			target are referenced by id.
		*/
		...
		*/
		static void CopyNonZeroAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
			Copy nonzero colors from a source animation to a target animation for all
		...
		*/
		...
		/*
			...
			source and target are referenced by name.
		*/
		static void CopyNonZeroAllKeysAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int offset);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroAllKeysAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double offset);
		/*
			Copy nonzero colors from source animation to target animation for the specified
			frame. Source and target are referenced by id.
		*/
		static void CopyNonZeroAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroAllKeysNameD(const char* sourceAnimation, const char* targetAnimation, double frameId);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void CopyNonZeroAllKeysOffsetName(const char* sourceAnimation, const char* targetAnimation, int frameId, int offset);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroAllKeysOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double offset);
		/*
			Copy animation key color from the source animation to the target animation
		...
		*/
		...
		/*
			...
			for the given frame where color is not zero.
		*/
		static void CopyNonZeroKeyColorName(const char* sourceAnimation, const char* targetAnimation, int frameId, int rzkey);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroKeyColorNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double rzkey);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void CopyNonZeroTargetAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroTargetAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
			Copy nonzero colors from the source animation to the target animation where
			the target color is nonzero for all frames. Source and target are referenced
			by name.
		*/
		...
		/*
			...
			referenced by name.
		*/
		static void CopyNonZeroTargetAllKeysAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int offset);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroTargetAllKeysAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double offset);
		/*
			Copy nonzero colors from the source animation to the target animation where
			the target color is nonzero for the specified frame. The source and target
			are referenced by name.
		*/
		static void CopyNonZeroTargetAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroTargetAllKeysNameD(const char* sourceAnimation, const char* targetAnimation, double frameId);
		/*
			Copy nonzero colors from the source animation to the target animation where
		...
		*/
		static void CopyNonZeroTargetAllKeysOffsetName(const char* sourceAnimation, const char* targetAnimation, int frameId, int offset);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroTargetAllKeysOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double offset);
		/*
			Copy nonzero colors from the source animation to the target animation where
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void CopyNonZeroTargetZeroAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double CopyNonZeroTargetZeroAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
		...
		*/
		...
		/*
			...
			0.0 to 1.0. Reference the animation by name.
		*/
		static void CopyRedChannelAllFramesName(const char* path, float greenIntensity, float blueIntensity);
		/*
			D suffix for limited data types.
		*/
		static double CopyRedChannelAllFramesNameD(const char* path, double greenIntensity, double blueIntensity);
		/*
		...
		*/
		...
		/*
			...
			Source and target are referenced by name.
		*/
		static void CopyZeroAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double CopyZeroAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
			Copy zero colors from source animation to target animation for all frames
		...
		*/
		static void CopyZeroAllKeysAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int offset);
		/*
			D suffix for limited data types.
		*/
		static double CopyZeroAllKeysAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double offset);
		/*
			Copy zero colors from source animation to target animation for the frame.
			Source and target are referenced by name.
		*/
		static void CopyZeroAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
		/*
			Copy zero colors from source animation to target animation for the frame
		...
		*/
		...
		/*
			...
			Source and target are referenced by name.
		*/
		static void CopyZeroAllKeysOffsetName(const char* sourceAnimation, const char* targetAnimation, int frameId, int offset);
		/*
		...
		*/
		static void CopyZeroKeyColorName(const char* sourceAnimation, const char* targetAnimation, int frameId, int rzkey);
		/*
			D suffix for limited data types.
		*/
		static double CopyZeroKeyColorNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double rzkey);
		/*
		...
		*/
		static void CopyZeroTargetAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double CopyZeroTargetAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
			Copy nonzero color from source animation to target animation where target
			is zero for the frame. Source and target are referenced by name.
		*/
		static void CopyZeroTargetAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
		/*
		...
		*/
		...
		/*
			...
			one upon failure.
		*/
		static int CreateAnimation(const char* path, int deviceType, int device);
		/*
		...
		*/
		static void DuplicateFirstFrameName(const char* path, int frameCount);
		/*
			D suffix for limited data types.
		*/
		static double DuplicateFirstFrameNameD(const char* path, double frameCount);
		/*
		...
		*/
		static void DuplicateFramesName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double DuplicateFramesNameD(const char* path);
		/*
		...
		*/
		static void DuplicateMirrorFramesName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double DuplicateMirrorFramesNameD(const char* path);
		/*
		...
		*/
		static void FadeEndFramesName(const char* path, int fade);
		/*
			D suffix for limited data types.
		*/
		static double FadeEndFramesNameD(const char* path, double fade);
		/*
		...
		*/
		static void FadeStartFramesName(const char* path, int fade);
		/*
			D suffix for limited data types.
		*/
		static double FadeStartFramesNameD(const char* path, double fade);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void FillColorAllFramesName(const char* path, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillColorAllFramesNameD(const char* path, double color);
		/*
		...
		*/
		static void FillColorAllFramesRGBName(const char* path, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillColorAllFramesRGBNameD(const char* path, double red, double green, double blue);
		/*
			Set the RGB value for all colors in the specified frame. Animation is referenced
			by name.
		*/
		static void FillColorName(const char* path, int frameId, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillColorNameD(const char* path, double frameId, double color);
		/*
			Set the RGB value for all colors in the specified frame. Animation is referenced
			by id.
		*/
		...
		/*
			...
			by name.
		*/
		static void FillColorRGBName(const char* path, int frameId, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillColorRGBNameD(const char* path, double frameId, double red, double green, double blue);
		/*
		...
		*/
		static void FillNonZeroColorAllFramesName(const char* path, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillNonZeroColorAllFramesNameD(const char* path, double color);
		/*
			This method will only update colors in the animation that are not already
			set to black. Set the RGB value for a subset of colors for all frames.
		...
		*/
		static void FillNonZeroColorAllFramesRGBName(const char* path, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillNonZeroColorAllFramesRGBNameD(const char* path, double red, double green, double blue);
		/*
			This method will only update colors in the animation that are not already
			set to black. Set the RGB value for a subset of colors in the specified
			frame. Animation is referenced by name.
		*/
		static void FillNonZeroColorName(const char* path, int frameId, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillNonZeroColorNameD(const char* path, double frameId, double color);
		/*
			This method will only update colors in the animation that are not already
			set to black. Set the RGB value for a subset of colors in the specified
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void FillNonZeroColorRGBName(const char* path, int frameId, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillNonZeroColorRGBNameD(const char* path, double frameId, double red, double green, double blue);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void FillRandomColorsAllFramesName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double FillRandomColorsAllFramesNameD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void FillRandomColorsBlackAndWhiteAllFramesName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double FillRandomColorsBlackAndWhiteAllFramesNameD(const char* path);
		/*
			Fill the frame with random black and white values for the specified frame.
			Animation is referenced by name.
		*/
		static void FillRandomColorsBlackAndWhiteName(const char* path, int frameId);
		/*
			D suffix for limited data types.
		*/
		static double FillRandomColorsBlackAndWhiteNameD(const char* path, double frameId);
		/*
			Fill the frame with random RGB values for the given frame. Animation is
			referenced by name.
		*/
		static void FillRandomColorsName(const char* path, int frameId);
		/*
			D suffix for limited data types.
		*/
		static double FillRandomColorsNameD(const char* path, double frameId);
		/*
		...
		*/
		static void FillThresholdColorsAllFramesName(const char* path, int threshold, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdColorsAllFramesNameD(const char* path, double threshold, double color);
		/*
			Fill all frames with RGB color where the animation color is less than the
		...
		*/
		static void FillThresholdColorsAllFramesRGBName(const char* path, int threshold, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdColorsAllFramesRGBNameD(const char* path, double threshold, double red, double green, double blue);
		/*
		...
		*/
		static void FillThresholdColorsMinMaxAllFramesRGBName(const char* path, int minThreshold, int minRed, int minGreen, int minBlue, int maxThreshold, int maxRed, int maxGreen, int maxBlue);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdColorsMinMaxAllFramesRGBNameD(const char* path, double minThreshold, double minRed, double minGreen, double minBlue, double maxThreshold, double maxRed, double maxGreen, double maxBlue);
		/*
		...
		*/
		static void FillThresholdColorsMinMaxRGBName(const char* path, int frameId, int minThreshold, int minRed, int minGreen, int minBlue, int maxThreshold, int maxRed, int maxGreen, int maxBlue);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdColorsMinMaxRGBNameD(const char* path, double frameId, double minThreshold, double minRed, double minGreen, double minBlue, double maxThreshold, double maxRed, double maxGreen, double maxBlue);
		/*
			Fill the specified frame with RGB color where the animation color is less
			than the RGB threshold. Animation is referenced by name.
		*/
		static void FillThresholdColorsName(const char* path, int frameId, int threshold, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdColorsNameD(const char* path, double frameId, double threshold, double color);
		/*
			Fill the specified frame with RGB color where the animation color is less
			than the RGB threshold. Animation is referenced by id.
		*/
		...
		/*
			...
			than the RGB threshold. Animation is referenced by name.
		*/
		static void FillThresholdColorsRGBName(const char* path, int frameId, int threshold, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdColorsRGBNameD(const char* path, double frameId, double threshold, double red, double green, double blue);
		/*
			Fill all frames with RGB color where the animation color is less than the
			RGB threshold. Animation is referenced by id.
		*/
		...
		/*
			...
			RGB threshold. Animation is referenced by name.
		*/
		static void FillThresholdRGBColorsAllFramesRGBName(const char* path, int redThreshold, int greenThreshold, int blueThreshold, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdRGBColorsAllFramesRGBNameD(const char* path, double redThreshold, double greenThreshold, double blueThreshold, double red, double green, double blue);
		/*
			Fill the specified frame with RGB color where the animation color is less
			than the RGB threshold. Animation is referenced by id.
		*/
		...
		/*
			...
			than the RGB threshold. Animation is referenced by name.
		*/
		static void FillThresholdRGBColorsRGBName(const char* path, int frameId, int redThreshold, int greenThreshold, int blueThreshold, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillThresholdRGBColorsRGBNameD(const char* path, double frameId, double redThreshold, double greenThreshold, double blueThreshold, double red, double green, double blue);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void FillZeroColorAllFramesName(const char* path, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillZeroColorAllFramesNameD(const char* path, double color);
		/*
			Fill all frames with RGB color where the animation color is zero. Animation
			is referenced by id.
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void FillZeroColorAllFramesRGBName(const char* path, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillZeroColorAllFramesRGBNameD(const char* path, double red, double green, double blue);
		/*
			Fill the specified frame with RGB color where the animation color is zero.
			Animation is referenced by name.
		*/
		static void FillZeroColorName(const char* path, int frameId, int color);
		/*
			D suffix for limited data types.
		*/
		static double FillZeroColorNameD(const char* path, double frameId, double color);
		/*
			Fill the specified frame with RGB color where the animation color is zero.
			Animation is referenced by id.
		*/
		...
		/*
			...
			Animation is referenced by name.
		*/
		static void FillZeroColorRGBName(const char* path, int frameId, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double FillZeroColorRGBNameD(const char* path, double frameId, double red, double green, double blue);
		/*
		...
		*/
		...
		/*
			...
			referenced by name.
		*/
		static int Get1DColorName(const char* path, int frameId, int led);
		/*
			D suffix for limited data types.
		*/
		static double Get1DColorNameD(const char* path, double frameId, double led);
		/*
		...
		*/
		...
		/*
			...
			Animation is referenced by name.
		*/
		static int Get2DColorName(const char* path, int frameId, int row, int column);
		/*
			D suffix for limited data types.
		*/
		static double Get2DColorNameD(const char* path, double frameId, double row, double column);
		/*
			Get the animation id for the named animation.
		*/
		static int GetAnimation(const char* name);
		/*
		...
		*/
		...
		/*
			D suffix for limited data types.
		*/
		static double GetAnimationD(const char* name);
		/*
		...
		*/
		static const char* GetAnimationName(int animationId);
		/*
		...
		*/
		static int GetCurrentFrameName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double GetCurrentFrameNameD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			negative one upon failure.
		*/
		static int GetDeviceName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double GetDeviceNameD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			upon success. Returns negative one upon failure.
		*/
		static int GetDeviceTypeName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double GetDeviceTypeNameD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			one upon failure.
		*/
		static int GetFrameCountName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double GetFrameCountNameD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			zero upon failure.
		*/
		static float GetFrameDurationName(const char* path, int frameId);
		/*
			Get the frame colors and duration (in seconds) for a `Chroma` animation
			...
			Returns the animation id upon success. Returns negative one upon failure.
		*/
		static int GetFrameName(const char* path, int frameId, float* duration, int* colors, int length, int* keys, int keysLength);
		/*
		...
		*/
		...
		/*
			D suffix for limited data types.
		*/
		static double GetKeyColorD(const char* path, double frameId, double rzkey);
		/*
			Get the color of an animation key for the given frame referenced by name.
		*/
		static int GetKeyColorName(const char* path, int frameId, int rzkey);
		/*
		...
		*/
		...
		/*
			...
			zero upon failure.
		*/
		static float GetTotalDurationName(const char* path);
		/*
		...
		*/
		static bool HasAnimationLoopName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double HasAnimationLoopNameD(const char* path);
		/*
		...
		*/
		static void InsertDelayName(const char* path, int frameId, int delay);
		/*
			D suffix for limited data types.
		*/
		static double InsertDelayNameD(const char* path, double frameId, double delay);
		/*
		...
		*/
		...
		/*
			...
			referenced by name.
		*/
		static void InsertFrameName(const char* path, int sourceFrame, int targetFrame);
		/*
			D suffix for limited data types.
		*/
		static double InsertFrameNameD(const char* path, double sourceFrame, double targetFrame);
		/*
		...
		*/
		static void InvertColorsAllFramesName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double InvertColorsAllFramesNameD(const char* path);
		/*
			Invert all the colors at the specified frame. Animation is referenced by
			name.
		*/
		static void InvertColorsName(const char* path, int frameId);
		/*
			D suffix for limited data types.
		*/
		static double InvertColorsNameD(const char* path, double frameId);
		/*
		...
		*/
		static bool IsAnimationPausedName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double IsAnimationPausedNameD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static bool IsPlayingName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double IsPlayingNameD(const char* path);
		/*
		...
		*/
		static void LoadAnimationName(const char* path);
		/*
			Load a composite set of animations.
		*/
		static void LoadComposite(const char* name);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void MakeBlankFramesName(const char* path, int frameCount, float duration, int color);
		/*
			D suffix for limited data types.
		*/
		static double MakeBlankFramesNameD(const char* path, double frameCount, double duration, double color);
		/*
			Make a blank animation for the length of the frame count. Frame duration
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void MakeBlankFramesRandomBlackAndWhiteName(const char* path, int frameCount, float duration);
		/*
			D suffix for limited data types.
		*/
		static double MakeBlankFramesRandomBlackAndWhiteNameD(const char* path, double frameCount, double duration);
		/*
			Make a blank animation for the length of the frame count. Frame duration
			defaults to the duration. The frame color is random. Animation is referenced
			by name.
		*/
		static void MakeBlankFramesRandomName(const char* path, int frameCount, float duration);
		/*
			D suffix for limited data types.
		*/
		static double MakeBlankFramesRandomNameD(const char* path, double frameCount, double duration);
		/*
			Make a blank animation for the length of the frame count. Frame duration
			defaults to the duration. The frame color defaults to color. Animation
			is referenced by id.
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void MakeBlankFramesRGBName(const char* path, int frameCount, float duration, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double MakeBlankFramesRGBNameD(const char* path, double frameCount, double duration, double red, double green, double blue);
		/*
		...
		*/
		static void MultiplyColorLerpAllFramesName(const char* path, int color1, int color2);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyColorLerpAllFramesNameD(const char* path, double color1, double color2);
		/*
		...
		*/
		...
		/*
			...
			the frame will not be affected by this method.
		*/
		static void MultiplyIntensityAllFramesName(const char* path, float intensity);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyIntensityAllFramesNameD(const char* path, double intensity);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void MultiplyIntensityAllFramesRGBName(const char* path, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyIntensityAllFramesRGBNameD(const char* path, double red, double green, double blue);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void MultiplyIntensityColorAllFramesName(const char* path, int color);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyIntensityColorAllFramesNameD(const char* path, double color);
		/*
			Multiply the specific frame by the RBG color intensity. Animation is referenced
			by name.
		*/
		static void MultiplyIntensityColorName(const char* path, int frameId, int color);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyIntensityColorNameD(const char* path, double frameId, double color);
		/*
			Multiply all the colors in the frame by the intensity value. The valid the
			intensity range is from 0.0 to 255.0. RGB components are multiplied equally.
			An intensity of 0.5 would half the color value. Black colors in the frame
			will not be affected by this method.
		*/
		static void MultiplyIntensityName(const char* path, int frameId, float intensity);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyIntensityNameD(const char* path, double frameId, double intensity);
		/*
			Multiply the specific frame by the RBG color intensity. Animation is referenced
			by id.
		*/
		...
		/*
			...
			by name.
		*/
		static void MultiplyIntensityRGBName(const char* path, int frameId, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyIntensityRGBNameD(const char* path, double frameId, double red, double green, double blue);
		/*
		...
		*/
		static void MultiplyNonZeroTargetColorLerpAllFramesName(const char* path, int color1, int color2);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyNonZeroTargetColorLerpAllFramesNameD(const char* path, double color1, double color2);
		/*
		...
		*/
		...
		/*
			...
			name.
		*/
		static void MultiplyNonZeroTargetColorLerpAllFramesRGBName(const char* path, int red1, int green1, int blue1, int red2, int green2, int blue2);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyNonZeroTargetColorLerpAllFramesRGBNameD(const char* path, double red1, double green1, double blue1, double red2, double green2, double blue2);
		/*
			Multiply the specific frame by the color lerp result between color 1 and
			2 using the frame color value as the `t` value. Animation is referenced
			by id.
		...
		*/
		...
		/*
			...
			the frame color value as the `t` value. Animation is referenced by name.
		*/
		static void MultiplyTargetColorLerpAllFramesName(const char* path, int color1, int color2);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyTargetColorLerpAllFramesNameD(const char* path, double color1, double color2);
		/*
		...
		*/
		static void MultiplyTargetColorLerpAllFramesRGBName(const char* path, int red1, int green1, int blue1, int red2, int green2, int blue2);
		/*
			D suffix for limited data types.
		*/
		static double MultiplyTargetColorLerpAllFramesRGBNameD(const char* path, double red1, double green1, double blue1, double red2, double green2, double blue2);
		/*
			Multiply the specific frame by the color lerp result between color 1 and
			2 using the frame color value as the `t` value. Animation is referenced
			by name.
		*/
		static void MultiplyTargetColorLerpName(const char* path, int frameId, int color1, int color2);
		/*
		...
		*/
		...
		/*
			...
			color. Positive values add color.
		*/
		static void OffsetColorsAllFramesName(const char* path, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double OffsetColorsAllFramesNameD(const char* path, double red, double green, double blue);
		/*
			Offset all colors in the frame using the RGB offset. Use the range of -255
			to 255 for red, green, and blue parameters. Negative values remove color.
			Positive values add color.
		*/
		static void OffsetColorsName(const char* path, int frameId, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double OffsetColorsNameD(const char* path, double frameId, double red, double green, double blue);
		/*
			This method will only update colors in the animation that are not already
		...
		*/
		...
		/*
			...
			values remove color. Positive values add color.
		*/
		static void OffsetNonZeroColorsAllFramesName(const char* path, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double OffsetNonZeroColorsAllFramesNameD(const char* path, double red, double green, double blue);
		/*
			This method will only update colors in the animation that are not already
			set to black. Offset a subset of colors in the frame using the RGB offset.
			Use the range of -255 to 255 for red, green, and blue parameters. Negative
			values remove color. Positive values add color.
		*/
		static void OffsetNonZeroColorsName(const char* path, int frameId, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double OffsetNonZeroColorsNameD(const char* path, double frameId, double red, double green, double blue);
		/*
		...
		*/
		static int OpenAnimation(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double OpenAnimationD(const char* path);
		/*
		...
		*/
		static int OpenAnimationFromMemory(const BYTE* data, const char* name);
		/*
		...
		*/
		static int OpenEditorDialog(const char* path);
		/*
			Open the named animation in the editor dialog and play the animation at
			start.
		*/
		static int OpenEditorDialogAndPlay(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double OpenEditorDialogAndPlayD(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double OpenEditorDialogD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void OverrideFrameDurationName(const char* path, float duration);
		/*
		...
		*/
		static void PauseAnimationName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double PauseAnimationNameD(const char* path);
		/*
		...
		*/
		static void PlayAnimationFrameName(const char* path, int frameId, bool loop);
		/*
			D suffix for limited data types.
		*/
		static double PlayAnimationFrameNameD(const char* path, double frameId, double loop);
		/*
		...
		*/
		static void PlayAnimationName(const char* path, bool loop);
		/*
			D suffix for limited data types.
		*/
		static double PlayAnimationNameD(const char* path, double loop);
		/*
		...
		*/
		static void PlayComposite(const char* name, bool loop);
		/*
			D suffix for limited data types.
		*/
		static double PlayCompositeD(const char* name, double loop);
		/*
		...
		*/
		static void PreviewFrameName(const char* path, int frameId);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void ReduceFramesName(const char* path, int n);
		/*
			D suffix for limited data types.
		*/
		static double ReduceFramesNameD(const char* path, double n);
		/*
		...
		*/
		static void ResumeAnimationName(const char* path, bool loop);
		/*
			D suffix for limited data types.
		*/
		static double ResumeAnimationNameD(const char* path, double loop);
		/*
		...
		*/
		...
		/*
			...
			referenced by name.
		*/
		static void ReverseAllFramesName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double ReverseAllFramesNameD(const char* path);
		/*
			Save the animation referenced by id to the path specified.
		*/
		static int SaveAnimation(int animationId, const char* path);
		/*
			Save the named animation to the target path specified.
		*/
		static int SaveAnimationName(const char* sourceAnimation, const char* targetAnimation);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void Set1DColorName(const char* path, int frameId, int led, int color);
		/*
			D suffix for limited data types.
		*/
		static double Set1DColorNameD(const char* path, double frameId, double led, double color);
		/*
		...
		*/
		...
		/*
			...
			The animation is referenced by name.
		*/
		static void Set2DColorName(const char* path, int frameId, int row, int column, int color);
		/*
			D suffix for limited data types.
		*/
		static double Set2DColorNameD(const char* path, double frameId, double rowColumnIndex, double color);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void SetChromaCustomColorAllFramesName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double SetChromaCustomColorAllFramesNameD(const char* path);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void SetChromaCustomFlagName(const char* path, bool flag);
		/*
			D suffix for limited data types.
		*/
		static double SetChromaCustomFlagNameD(const char* path, double flag);
		/*
		...
		*/
		static void SetCurrentFrameName(const char* path, int frameId);
		/*
			D suffix for limited data types.
		*/
		static double SetCurrentFrameNameD(const char* path, double frameId);
		/*
		...
		*/
		static void SetIdleAnimationName(const char* path);
		/*
		...
		*/
		...
		/*
			...
			by name.
		*/
		static void SetKeyColorAllFramesName(const char* path, int rzkey, int color);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyColorAllFramesNameD(const char* path, double rzkey, double color);
		/*
			Set the key to the specified key color for all frames. Animation is referenced
			by id.
		*/
		...
		/*
			...
			by name.
		*/
		static void SetKeyColorAllFramesRGBName(const char* path, int rzkey, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyColorAllFramesRGBNameD(const char* path, double rzkey, double red, double green, double blue);
		/*
			Set animation key to a static color for the given frame.
		*/
		static void SetKeyColorName(const char* path, int frameId, int rzkey, int color);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyColorNameD(const char* path, double frameId, double rzkey, double color);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void SetKeyColorRGBName(const char* path, int frameId, int rzkey, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyColorRGBNameD(const char* path, double frameId, double rzkey, double red, double green, double blue);
		/*
		...
		*/
		...
		/*
			...
			color is not already black.
		*/
		static void SetKeyNonZeroColorName(const char* path, int frameId, int rzkey, int color);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyNonZeroColorNameD(const char* path, double frameId, double rzkey, double color);
		/*
		...
		*/
		static void SetKeyNonZeroColorRGBName(const char* path, int frameId, int rzkey, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyNonZeroColorRGBNameD(const char* path, double frameId, double rzkey, double red, double green, double blue);
		/*
			Set animation key by row and column to a static color for the given frame.
		*/
		static void SetKeyRowColumnColorName(const char* path, int frameId, int row, int column, int color);
		/*
		...
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void SetKeysColorAllFramesName(const char* path, const int* rzkeys, int keyCount, int color);
		/*
			Set an array of animation keys to a static color for all frames. Animation
			is referenced by id.
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void SetKeysColorAllFramesRGBName(const char* path, const int* rzkeys, int keyCount, int red, int green, int blue);
		/*
			Set an array of animation keys to a static color for the given frame.
		*/
		static void SetKeysColorName(const char* path, int frameId, const int* rzkeys, int keyCount, int color);
		/*
			Set an array of animation keys to a static color for the given frame. Animation
			is referenced by id.
		*/
		...
		/*
			...
			is referenced by name.
		*/
		static void SetKeysColorRGBName(const char* path, int frameId, const int* rzkeys, int keyCount, int red, int green, int blue);
		/*
		...
		*/
		static void SetKeysNonZeroColorAllFramesName(const char* path, const int* rzkeys, int keyCount, int color);
		/*
			Set an array of animation keys to a static color for the given frame if
			the existing color is not already black. Reference animation by name.
		*/
		static void SetKeysNonZeroColorName(const char* path, int frameId, const int* rzkeys, int keyCount, int color);
		/*
			Set an array of animation keys to a static color for the given frame where
			the color is not black. Animation is referenced by id.
		*/
		...
		*/
		static void SetKeysNonZeroColorRGBName(const char* path, int frameId, const int* rzkeys, int keyCount, int red, int green, int blue);
		/*
			Set an array of animation keys to a static color for the given frame where
		...
		*/
		static void SetKeysZeroColorAllFramesName(const char* path, const int* rzkeys, int keyCount, int color);
		/*
			Set an array of animation keys to a static color for all frames where the
			color is black. Animation is referenced by id.
		*/
		...
		/*
			...
			color is black. Animation is referenced by name.
		*/
		static void SetKeysZeroColorAllFramesRGBName(const char* path, const int* rzkeys, int keyCount, int red, int green, int blue);
		/*
			Set an array of animation keys to a static color for the given frame where
			the color is black. Animation is referenced by name.
		*/
		static void SetKeysZeroColorName(const char* path, int frameId, const int* rzkeys, int keyCount, int color);
		/*
			Set an array of animation keys to a static color for the given frame where
			the color is black. Animation is referenced by id.
		*/
		...
		/*
			...
			the color is black. Animation is referenced by name.
		*/
		static void SetKeysZeroColorRGBName(const char* path, int frameId, const int* rzkeys, int keyCount, int red, int green, int blue);
		/*
		...
		*/
		static void SetKeyZeroColorName(const char* path, int frameId, int rzkey, int color);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyZeroColorNameD(const char* path, double frameId, double rzkey, double color);
		/*
			Set animation key to a static color for the given frame where the color
			is black. Animation is referenced by id.
		*/
		...
		/*
			...
			is black. Animation is referenced by name.
		*/
		static void SetKeyZeroColorRGBName(const char* path, int frameId, int rzkey, int red, int green, int blue);
		/*
			D suffix for limited data types.
		*/
		static double SetKeyZeroColorRGBNameD(const char* path, double frameId, double rzkey, double red, double green, double blue);
		/*
		...
		*/
		static void StopAnimationName(const char* path);
		/*
			D suffix for limited data types.
		*/
		static double StopAnimationNameD(const char* path);
		/*
		...
		*/
		static void StopComposite(const char* name);
		/*
			D suffix for limited data types.
		*/
		static double StopCompositeD(const char* name);
		/*
		...
		*/
		static void SubtractNonZeroAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double SubtractNonZeroAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
			Subtract the source color from the target color for all frames where the
		...
		*/
		...
		/*
			...
			Source and target are referenced by name.
		*/
		static void SubtractNonZeroAllKeysAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int offset);
		/*
			D suffix for limited data types.
		*/
		static double SubtractNonZeroAllKeysAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double offset);
		/*
			Subtract the source color from the target color for the frame where the
			target color is not black. Source and target are referenced by name.
		*/
		static void SubtractNonZeroAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
		/*
		...
		*/
		static void SubtractNonZeroAllKeysOffsetName(const char* sourceAnimation, const char* targetAnimation, int frameId, int offset);
		/*
			D suffix for limited data types.
		*/
		static double SubtractNonZeroAllKeysOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double offset);
		/*
		...
		*/
		static void SubtractNonZeroTargetAllKeysAllFramesName(const char* sourceAnimation, const char* targetAnimation);
		/*
			D suffix for limited data types.
		*/
		static double SubtractNonZeroTargetAllKeysAllFramesNameD(const char* sourceAnimation, const char* targetAnimation);
		/*
			Subtract the source color from the target color where the target color is
		...
		*/
		static void SubtractNonZeroTargetAllKeysAllFramesOffsetName(const char* sourceAnimation, const char* targetAnimation, int offset);
		/*
			D suffix for limited data types.
		*/
		static double SubtractNonZeroTargetAllKeysAllFramesOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double offset);
		/*
			Subtract the source color from the target color where the target color is
		...
		*/
		...
		/*
			...
			and target by name.
		*/
		static void SubtractNonZeroTargetAllKeysOffsetName(const char* sourceAnimation, const char* targetAnimation, int frameId, int offset);
		/*
			D suffix for limited data types.
		*/
		static double SubtractNonZeroTargetAllKeysOffsetNameD(const char* sourceAnimation, const char* targetAnimation, double frameId, double offset);
		/*
		...
		*/
		...
		/*
			...
			is more than the max threshold. Animation is referenced by name.
		*/
		static void SubtractThresholdColorsMinMaxAllFramesRGBName(const char* path, const int minThreshold, const int minRed, const int minGreen, const int minBlue, const int maxThreshold, const int maxRed, const int maxGreen, const int maxBlue);
		/*
			D suffix for limited data types.
		*/
		static double SubtractThresholdColorsMinMaxAllFramesRGBNameD(const char* path, double minThreshold, double minRed, double minGreen, double minBlue, double maxThreshold, double maxRed, double maxGreen, double maxBlue);
		/*
		...
		*/
		static void SubtractThresholdColorsMinMaxRGBName(const char* path, const int frameId, const int minThreshold, const int minRed, const int minGreen, const int minBlue, const int maxThreshold, const int maxRed, const int maxGreen, const int maxBlue);
		/*
			D suffix for limited data types.
		*/
		static double SubtractThresholdColorsMinMaxRGBNameD(const char* path, const int frameId, const int minThreshold, const int minRed, const int minGreen, const int minBlue, const int maxThreshold, const int maxRed, const int maxGreen, const int maxBlue);
		/*
		...
		*/
		static void TrimEndFramesName(const char* path, int lastFrameId);
		/*
			D suffix for limited data types.
		*/
		static double TrimEndFramesNameD(const char* path, double lastFrameId);
		/*
		...
		*/
		static void TrimFrameName(const char* path, int frameId);
		/*
			D suffix for limited data types.
		*/
		static double TrimFrameNameD(const char* path, double frameId);
		/*
		...
		*/
		static void TrimStartFramesName(const char* path, int numberOfFrames);
		/*
			D suffix for limited data types.
		*/
		static double TrimStartFramesNameD(const char* path, double numberOfFrames);
		/*
		...
		*/
		static void UnloadAnimationName(const char* path);
		/*
			Unload the the composite set of animation effects. Reference the animation
			by name.
		*/
		static void UnloadComposite(const char* name);
		/*
		...
		*/
		...
		/*
			...
			Returns the animation id upon success. Returns negative one upon failure.
		*/
		static int UpdateFrameName(const char* path, int frameId, float duration, int* colors, int length, int* keys, int keysLength);
		/*
		...
		*/
		...
		/*
			...
			animation by name.
		*/
		static void UsePreloadingName(const char* path, bool flag);
#pragma endregion
		...
		static std::string _sResultGetAnimationName;
	};
}
